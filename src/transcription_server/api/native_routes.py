...
async def health(
    ...
    result = HealthOut(
        ...
        diarization_model=state.engine_display_name(state.diarization),
        ...
        asr_state=getattr(state.asr, "state", "loaded"),
        diarization_state=state.engine_state(state.diarization),
